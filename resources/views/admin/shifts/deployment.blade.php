...
@section('content')
    ...
    <div class="container mx-auto w-1/2">
        <form>
            ...
            <div class="mb-6">
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900">方法</label>
                {!! Form::select('deployment_method', config('shifts.deployment_method'), false, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 w-full']) !!}
            </div>
